...
public class HscFragment extends BaseFragment {
    ...
    private static boolean isHSC;
    private FragmentManager getManager;

    private View viewHsc;
    public HscFragment(boolean isHSC)
    {
        this.isHSC=isHSC;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        viewHsc= inflater.inflate(R.layout.fragment_hsc,container,false);
        return viewHsc;
    }

    @Override
    public void initView(View view) {
        rvGridView = (RecyclerView) viewHsc.findViewById(R.id.fragment_hsc_rv_container);
...
//                        statListModel.set(user_details.getKey());
                    ...
                    fragmentSscAdapter = new FragmentSscAdapter(getActivity(), stateArrayList, HscFragment.this, isHSC, getManager);
